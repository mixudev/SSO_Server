            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                        Buat entri client baru yang terhubung ke MixuAuth via OAuth2
                    </p>
                </div>
            </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="block w-full rounded-lg border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 px-3.5 py-2.5 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 shadow-sm focus:border-violet-500 focus:ring-violet-500 focus:bg-white dark:focus:bg-gray-900 transition-colors @error('category') border-red-400 dark:border-red-500 @enderror"
                                    />
                                    @error('category')
                                        <p class="mt-1.5 flex items-center gap-1 text-xs text-red-600 dark:text-red-400">
                                            <svg class="h-3 w-3 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5A.75.75 0 0110 5zm0 10a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" /></svg>
                        ...
                        <div class="p-6 space-y-5">
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        ...
                                        @foreach ($accessAreas as $area)
                                            <option value="{{ $area->id }}" @selected(old('access_area_id') == $area->id)>
                                                {{ $area->name }} — {{ $area->slug }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    class="block w-full rounded-lg border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 px-3.5 py-2.5 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 shadow-sm focus:border-violet-500 focus:ring-violet-500 focus:bg-white dark:focus:bg-gray-900 transition-colors resize-none @error('description') border-red-400 dark:border-red-500 @enderror"
