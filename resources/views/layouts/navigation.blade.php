            ...
            <div class="flex">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if ($navUser && $navUser->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.access-areas.index')" :active="request()->routeIs('admin.access-areas.*')">
                            {{ __('Access Areas') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if ($navUser && $navUser->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.access-areas.index')" :active="request()->routeIs('admin.access-areas.*')">
                    {{ __('Access Areas') }}
                </x-responsive-nav-link>
